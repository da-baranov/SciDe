...
begin
  ...
  Result := SciterApi.GetNativeClass(vm, ClsInfo.TypeName);
end;
...
begin
  OutputDebugStringA(PAnsiChar('VMClassBag ' + IntToStr(Integer(FVM)) + ' is being destroyed.'));
  FVM := nil;
  FList := nil;
  inherited;
end;
