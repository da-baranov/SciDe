...
function _SciterAPI: PSciterApi; stdcall; external 'sciter32.dll' name 'SciterAPI';
...
begin
  ...
  begin
    ...
    pFuncPtr := SciterApiFunc(GetProcAddress(HSCITER, 'SciterAPI'));
...
constructor ESciterCallException.Create(const AMethodName: String);
begin
  inherited CreateFmt('Method "%s" call failed.', [AMethodName]);
end;
